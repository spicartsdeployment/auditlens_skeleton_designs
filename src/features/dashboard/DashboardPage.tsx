  ...
  return (
    <div className="p-3 md:p-4 max-w-[1440px] mx-auto" style={{ background: G.canvas }}>
      ...
      */}
      ...
      <div
        className="mt-3 flex items-center gap-1 px-1 py-1 rounded-2xl"
      ...
      >
        ...
        {[
          ...
          <button
            ...
            style={{ color: G.secondary }}
            onMouseEnter={e => { e.currentTarget.style.background = G.canvas; e.currentTarget.style.color = G.primary }}
            onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = G.secondary }}
          >
            {item.label}
          </button>
        ))}
