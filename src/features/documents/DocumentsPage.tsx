...
import { G, PageHeader, DarkBtn, ContentCard } from '@/shared/components/GrayKpi'
...
export function DocumentsPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-[1400px] mx-auto" style={{ background: G.canvas }}>
      ...
      <div className="flex items-center gap-2 mb-6 rounded-2xl p-3 flex-wrap" style={{ background: G.white, border: `1px solid ${G.border}` }}>
      ...
      <ContentCard>
        <div className="p-5">
          {searchFiltered.length === 0 ? (
            <p className="text-sm text-center py-12" style={{ color: G.secondary }}>No documents found</p>
          ) : (
